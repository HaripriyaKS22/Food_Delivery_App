...
import 'package:homfoo/api.dart';
  ...
  try {
    ...
    if (localData != null) {
      ...
      if (response.statusCode == 200) {
        ...
        categoriesList.retainWhere((category) => categoryIds.contains(category['id']));
 ...
 List<int> categoryIds = [];
                                      ...
                                      Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            SizedBox(height: 2.0),
                                            Text(
                                              product["description"],style: TextStyle(color: Colors.grey),
  ...
  style: ButtonStyle(
    ...
    shape: MaterialStateProperty.all<RoundedRectangleBorder>(
      RoundedRectangleBorder(
        ...
        side: BorderSide(color: Color.fromARGB(255, 43, 43, 43)), // Set border color and width
      ),
    ),
  ...
  style: ButtonStyle(
    ...
    fixedSize: MaterialStateProperty.all<Size>(
      Size(150.0, 50.0), // Set the width and height as per your requirement
    ),
  ),
  child: Text(
    'ADD',
